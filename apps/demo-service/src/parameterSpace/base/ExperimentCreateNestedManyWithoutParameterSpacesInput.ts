...
@InputType()
class ExperimentCreateNestedManyWithoutParameterSpacesInput {
...
export { ExperimentCreateNestedManyWithoutParameterSpacesInput as ExperimentCreateNestedManyWithoutParameterSpacesInput };
