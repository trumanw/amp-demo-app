...
@InputType()
class ExperimentUpdateManyWithoutParameterSpacesInput {
...
export { ExperimentUpdateManyWithoutParameterSpacesInput as ExperimentUpdateManyWithoutParameterSpacesInput };
