...
@InputType()
class ExperimentCreateNestedManyWithoutSearchSpacesInput {
...
export { ExperimentCreateNestedManyWithoutSearchSpacesInput as ExperimentCreateNestedManyWithoutSearchSpacesInput };
